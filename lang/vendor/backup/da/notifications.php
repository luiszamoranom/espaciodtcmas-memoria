...
return [
    ...
    'unhealthy_backup_found_subject' => 'Vigtigt: BackupsPage for :application_name fejlbehæftede',
    'unhealthy_backup_found_subject_title' => 'Vigtigt: BackupsPage for :application_name er fejlbehæftede. :problem',
    'unhealthy_backup_found_body' => 'BackupsPage for :application_name på disken :disk_name er fejlbehæftede.',
    ...
    'unhealthy_backup_found_full' => 'BackupsPage bruger for meget plads. Nuværende disk forbrug er :disk_usage, hvilket er mere end den tilladte grænse på :disk_limit.',
